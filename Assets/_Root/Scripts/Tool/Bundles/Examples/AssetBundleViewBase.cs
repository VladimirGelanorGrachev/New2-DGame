...
namespace Tool.Bundles.Examples
{
    ...
    {
        private const string UrlAssetBundleSprites = "https://drive.google.com/uc?export=download&id=11QaTXNRmffc_CgoDGOXsVmF6xcinm-t1";
        private const string UrlAssetBundleAudio = "https://drive.google.com/uc?export=download&id=1LlPkajgsJhU4ZkNmVQ3IOXbt1BHAa6Ur";
